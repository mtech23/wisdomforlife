...
import { faMagnifyingGlass, faUserAlt, faPlay, faStar, faTable, faChainSlash } from "@fortawesome/free-solid-svg-icons";
                                                            ...
                                                            {item?.options?.map((data, optionIndex) => (
                                                                <p key={optionIndex} className="quiz_option">
                                                                    <input
                                                                        ...
                                                                        value={data.id}
                                                                        onChange={(e) => handleOptionChange(item.id, data.id)} /> {data?.text}
                                                                </p>
                                                            ))}
                                                        </p>
                                                    </li>
                                        ...
                                        <div className="enroll" >
                                            <div className="row">
                                                <div className="col-md-12">
                                                    {detail?.course_status === 'Free' ? <button className="btn"> Enroll Now</button> : <button className="btn1"
